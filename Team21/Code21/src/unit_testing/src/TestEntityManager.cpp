...
TEST_CASE("EntityManager can retrieve all Statements") {
    ...
    std::shared_ptr<Variable> variable = std::make_shared<Variable>(std::make_shared<std::string>("x"));
    std::shared_ptr<Procedure> procedure = std::make_shared<Procedure>(std::make_shared<std::string>("main"));
    ...
    entityManager->storeEntity(std::make_shared<Variable>(std::make_shared<std::string>("x")));
    entityManager->storeEntity(std::make_shared<Procedure>(std::make_shared<std::string>("main")));
